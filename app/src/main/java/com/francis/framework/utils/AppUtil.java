package com.francis.framework.utils;
...
import com.francis.framework.callback.OnExitAppCallback;
...
/**
 * Created by yeahmobi on 2015/3/24.
 */
public class AppUtil {


    public static String getMetaDataValue(String name, String def, Context context) throws RuntimeException {
        String value = getMetaDataValue(name, context);
        return (value == null) ? def : value;
    }

    private static String getMetaDataValue(String name, Context context) throws RuntimeException {
        Object value = null;
    ...
    public static long EXIT_APP_WAITTIME = 2000;
    public static long EXIT_APP_TOUCHTIME = 0;

    public static void ExitAPP(Context context,OnExitAppCallback onExitAppCallback){
        long currentTime = System.currentTimeMillis();
        if ((currentTime - EXIT_APP_TOUCHTIME) >=  EXIT_APP_WAITTIME) {
            T.show(context,context.getResources().getString(R.string.exit_app_msg),5*1000);
            EXIT_APP_TOUCHTIME = currentTime;
        } else {
            onExitAppCallback.OnExitApp();
        }
    }
